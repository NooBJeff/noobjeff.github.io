...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_select__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Preferences_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__CurrencyConverter__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__scss_index_scss__ = __webpack_require__(35);
...
const app = new __WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_js___default.a({
    el: "#app",
    data: {
        preferences: new __WEBPACK_IMPORTED_MODULE_2__Preferences_js__["a" /* Preferences */](),
        converter: new __WEBPACK_IMPORTED_MODULE_3__CurrencyConverter__["a" /* CurrencyConverter */](),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Preferences; });
...
class CurrencyConverter {
    constructor() {
        ...
        // this.abbr2NameChines = null;

        /**
         * 从网络或者本地缓存获取汇率
         * 其中的rate为相对美元的汇率
         * 即 rate = 1美元对应该币种数量
         * @type {{string:{imgNation, nameNation, abbrNation, rate}}}
         */
    ...
    loadFromAPI() {
        ...
        let that = this;
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(URL_API)
