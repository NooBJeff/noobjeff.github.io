...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scss_app_scss__ = __webpack_require__(7);
...
function LoadFile(file) {
    ...
    function loadFile(arrayStrings) {
        ...
        while (cur < arrayStrings.length) {
            ...
            if (!__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].isEmptyString(current)) {
                stackCache.push(current);
            } else {
                if (__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].isEmpty(stackCache)) {
                    // 忽略多个空行
                    continue;
                }
                ...
                let script = {
                    ...
                    timeStamp: (function (timeStamp) {
                        ...
                        return {
                            from: __WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].convertToMillisec(match[0], match[1], match[2], match[3]),
                            to: __WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].convertToMillisec(match[4], match[5], match[6], match[7]),
                        };
                    })(stackCache.shift()),
...
const app = new __WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_js___default.a({
    ...
    computed: {
        ...
        cur_hour: function () {
            return __WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].padZero(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].getHours(this.cur), 2);
        },
        cur_min: function () {
            return __WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].padZero(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].getMinutes(this.cur), 2);
        },
        cur_sec: function () {
            return __WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].padZero(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].getSeconds(this.cur), 2);
        },
        cur_mill: function () {
            return __WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].padZero(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].getMilliseconds(this.cur), 3);
        },
        max_hour: function () {
            return __WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].padZero(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].getHours(this.file.maxMill), 2);
        },
        max_min: function () {
            return __WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].padZero(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].getMinutes(this.file.maxMill), 2);
        },
        max_sec: function () {
            return __WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].padZero(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].getSeconds(this.file.maxMill), 2);
        },
        max_mill: function () {
            return __WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].padZero(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].getMilliseconds(this.file.maxMill), 3);
        }
    },
    methods: {
        /**
        ...
        btnSetTime: function () {
            ...
            const cur = __WEBPACK_IMPORTED_MODULE_1__helper__["a" /* default */].convertToMillisec(match[1], match[2], match[3], match[4]);
...
/* harmony default export */ __webpack_exports__["a"] = (_export);
...
// module
exports.push([module.i, "#app {\n  min-width: 512px; }\n  #app #area-main #area-time #time-meter #group-time-display {\n    cursor: pointer;\n    user-select: none; }\n  #app #area-main #area-time #time-slider input {\n    min-width: 200px;\n    width: 70%; }\n  #app #area-main #area-btn button {\n    font-size: 20px;\n    width: 75px;\n    margin: 0 5px; }\n", ""]);
